...
export class FirstSchemaaaaaaaa1770385219913 implements MigrationInterface {
  name = 'FirstSchemaaaaaaaa1770385219913';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "team_member_teamrole_enum" AS ENUM('owner', 'admin', 'member')`,
    );
    await queryRunner.query(
      `CREATE TABLE "team_member" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid NOT NULL, "teamId" uuid NOT NULL, "teamRole" "team_member_teamrole_enum" NOT NULL DEFAULT 'member', CONSTRAINT "UQ_bd2b3ef7569d75642e091853771" UNIQUE ("userId", "teamId"), CONSTRAINT "PK_649680684d72a20d279641469c5" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TYPE "team_member_teamrole_enum"`);
